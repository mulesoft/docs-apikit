...
* Supports XML 1.0 characters by default and XML 1.1 characters, including CO characters, through the xref:apikit-4-xml-reference.adoc#apikit-for-soap-system-properties[system property].
