...
APIkit for SOAP now has two versions so you can align the module with your Mule runtime and JDK versions. Choose the version that matches the platform you deploy today. For more information about installation, see xref:apikit-4-soap-prerequisites-task.adoc[].
