...
== Limitations
* APIKit for SOAP loses payload and variables after an error.
+
The workaround for this issue is discussed https://help.salesforce.com/s/articleView?language=en_US&id=001122088&type=1[here].
