...
APIkit for SOAP supports XML 1.0 characters by default.
To support XML 1.1 characters, including CO characters, you must configure the system property `mule.soapkit.allowControlCharacters` to `true`.
