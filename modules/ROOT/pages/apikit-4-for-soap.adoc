...
APIkit for SOAP simplifies building and integrating SOAP-based web services by handling message formats, headers, and WSDL binding against your existing SOAP endpoints. SOAP (Simple Object Access Protocol) exchanges structured payloads between services. APIkit for SOAP keeps those payloads aligned with your contracts. To lear more about automated configurations, data transformations, XML 1.0 defaults, and optional XML 1.1 C0 characters, see xref:apikit-for-soap-module-reference.adoc#apikit-for-soap-system-properties[system property].

[[choose-the-apikit-for-soap-module-version]]
== Choose the APIkit for SOAP Module Version

APIkit for SOAP now has two versions so you can align the module with your Mule runtime and JDK versions. Choose the version that matches the platform you deploy to today. For more information about installation, see xref:apikit-4-soap-prerequisites-task.adoc[].
...
* Supports XML 1.0 characters by default. Supports XML 1.1 C0 characters through the xref:apikit-for-soap-module-reference.adoc#apikit-for-soap-system-properties[system property].
