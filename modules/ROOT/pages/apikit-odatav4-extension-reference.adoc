...
* xref:apikit-odatav4-extension-reference.adoc#serialize-entity[Serialize Entity]
* xref:apikit-odatav4-extension-reference.adoc#serialize-entity-collection[Serialize Entity Collection]
* xref:apikit-odatav4-extension-reference.adoc#transform-to-sql-select[Transform To SQL Select]
