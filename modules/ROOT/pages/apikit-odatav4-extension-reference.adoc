...
| Database Schema a| String |  The name of the database schema to which the entity set belongs. If not empty, it will be prefixed to the table name in the WHERE clause. |  | 
| Page Size a| Number |  |  | 
| Config Ref a| ConfigurationProvider |  The name of the configuration to be used to execute this component |  | *x*
| Streaming Strategy a| * <<RepeatableInMemoryStream>>
* <<RepeatableFileStoreStream>>
