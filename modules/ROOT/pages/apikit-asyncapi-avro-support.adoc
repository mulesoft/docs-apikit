...
----
APIKit for async API supports only Async APIs where avro messages are defined inline. API specifications that refer to avro fragments are not supported.
