...
APIkit creates error-handling code using Mule 4 main mechanism. When something goes wrong with a part of the process, you receive a typed error with a message. This code covers common HTTP status codes, matched to types and error messages listed in this article.
