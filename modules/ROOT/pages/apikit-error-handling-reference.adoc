...
The following code shows the construction of an error handler for an HTTP 400 response. You can take this one as a reference to add your own custom status codes and messages.
