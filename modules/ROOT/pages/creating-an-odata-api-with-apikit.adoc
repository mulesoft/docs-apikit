...
+
. Download and import the project in Anypoint Studio(Right click in package explorer --> Click on import -->  and click Next --> Select the downloaded jar file and click Finish) :{attachmentsdir}/apikit-odata-example-master.jar[Mule project], `apikit-odata-example-master.jar`.
