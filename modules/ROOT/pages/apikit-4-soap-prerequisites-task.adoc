...
* APIkit for SOAP 1.7.0 supports JDK 8, 11, and 17 on Mule runtime 4.1.x and later. Use this version if you must stay on Mule runtime previous to 4.9.11, or if you're not ready for JDK 17-only deployments.
* APIkit for SOAP 2.0.0 requires JDK 17 and Mule runtime 4.9.11 or later. Use this version for new Mule projects.
