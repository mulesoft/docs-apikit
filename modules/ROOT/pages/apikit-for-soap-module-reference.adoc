...
* xref:apikit-for-soap-module-reference.adoc#fault[Fault]

* xref:apikit-for-soap-module-reference.adoc#router[Router]
...
xref:apikit-for-soap-module-reference.adoc#repeatable-file-store-stream[Non repeatable stream] |  Configure if repeatable streams is used and their behavior |  | 
| Operation | String |  |  | *x*
| Fault | String |  |  | *x*
