= Bindings and Parametrized Channels in APIkit for AsyncAPI
ifndef::env-site,env-github[]
include::_attributes.adoc[]
endif::[]

APIkit for AsyncAPI maps AsyncAPI channel bindings to Anypoint connectors such as Anypoint MQ, Kafka, and Solace PubSub+. Use binding parameters to tune publish and subscribe behavior for each channel. Parametrized channel names let you reuse one channel pattern across many topics or destinations without duplicating the specification.
