...
Although each module is designed for a family of web services, all modules share common usage patterns. So if you're a Mule developer who works with SOAP APIs, you can easily work with GraphQL, RAML, OData, or OAS APIs.
