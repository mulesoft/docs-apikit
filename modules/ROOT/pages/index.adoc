...
* Some APIkit modules include extensions for xref:studio::index.adoc[Anypoint Studio] and xref:code-builder::index.adoc[Anypoint Code Builder] for enhancing your editing experience if you choose to use the supported development environments.

== Prerequisites

You need to have access to xref:studio::index.adoc[Anypoint Studio] or xref:code-builder::index.adoc[Anypoint Code Builder] to scaffold a supported API specification with APIkit.
