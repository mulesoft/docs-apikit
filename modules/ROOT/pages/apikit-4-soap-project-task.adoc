...
This process walks you through the creation of a create a new Mule project based on a SOAP API specification.
...
<1> Select the expand icon: and select *Browse files...*.
