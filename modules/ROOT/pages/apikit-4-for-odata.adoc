...
. Click *Add...*
+
image::add-update-site.png["Window for installing new new software with the add button highlighted."]
...
+
image::select-odata-extension.png["Window highlighting the Anypoint odata plugin box and the next button."]
