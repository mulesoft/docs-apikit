...
+
image::apikit-for-soap-e8679.png["*Source* section of the APIkit backend flow empty."]
+
...
----
+
image::apikit-for-soap-475c0.png["*Transform Message* tab with the payload output."]
+
