...
If you chose a backend-first design approach for your Mule project, or if you have a Mule application containing business logic, you can convert them into an APIkit project and expose them as a REST service. Fulfill this task following two approaches:
...
For example, you chose a backend-first implementation approach and you created the following Mule application that retrieves users from a database:
...
You can follow this workflow to manually configure a functional router for your existing flows.
