= Converting an Existing Mule Project to an APIkit Project
...
. Click the APIkit Router to open the *Properties Editor*. In *Router configuration*, click image:add-16x16.png["Add button."].
+
...
. In Mappings, click image:add-16x16.png["Add button"] to create a new mapping.
+
...
Click *OK*.
+
image::map-resource-to-action.png["*New Mapping" window with *get:\users:api-config* data populated."]
+
