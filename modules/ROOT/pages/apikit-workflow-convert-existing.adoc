...
If you chose a backend-first design approach for your Mule project or a Mule application containing business logic, you can convert them into an APIkit project and expose them as a REST service. Fulfill this task following two approaches:
...
You can follow this workflow to configure a functional router for your existing flows manually.
