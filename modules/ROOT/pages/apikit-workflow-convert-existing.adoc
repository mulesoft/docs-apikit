...
* Delete the scaffolded flows for each resource and map the original flows as described in xref:apikit-workflow-convert-existing.adoc#step-3:-map-api-resources-actions-to-flows
[].
