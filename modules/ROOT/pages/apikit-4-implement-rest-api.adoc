...
* If you are importing your API specification from Design Center, select the *Download RAML from Design Center* tab.
+
...
+
The successful request for the `/usersbyid` resource, which contains user information for the user with ID 3, is confirmed by an HTTP 200 response along with a response body that includes a JSON example.
+
...
* xref:general::api-led-overview.adoc[] https://docs.mulesoft.com/general/api-led-overview[Tutorial: Build an API from Start to Finish]
