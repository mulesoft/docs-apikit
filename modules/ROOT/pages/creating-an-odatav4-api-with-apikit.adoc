...
OData V4 discourages the usage of PUT to update your entities because it replaces the entire entity with a new one and this operation can lead to data loss.
