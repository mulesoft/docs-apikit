...
Use SoapUI to identify an operation you implement by making the API fail. Create a request in SoapUI using the `OrderTshirt` operation to place an order for a large t-shirt for John. Because the API cannot handle this operation, a SOAP fault occurs.
