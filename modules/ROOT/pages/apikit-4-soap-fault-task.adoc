= Identifying Operations to Implement
ifndef::env-site,env-github[]
include::_attributes.adoc[]
endif::[]

Use SoapUI to identify an operation you implement by making the API fail. You use the `OrderTshirt` operation to create a request in SoapUI and place an order for a large t-shirt for John. As the API cannot handle this operation, a SOAP fault occurs.
