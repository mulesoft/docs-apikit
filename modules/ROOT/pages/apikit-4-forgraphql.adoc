...
GraphQL is a data query and manipulation language that enables API consumers to ask for the data that is only relevant to them. The APIkit for GraphQL module enables you to develop Mule applications and supports the implementation of GraphQL services. These services use connectors to map GraphQL APIs to the existing backends where source data is stored.
