...
. From the *File* menu, select *New* > *Mule Project*.
...
+
image::new-mule-project-browse-files.png["Project Settings for a New Mule Project, including Project Name, Runtime, Maven Settings, Version Control System Support, APIkit Settings, and API Definition.",height=633,width=600]
+
. Click *Finish*.
...
+
image::try-it-warning.png["The Try It feature is disabled because baseURI is not present."]
+
...
+
image::get-button.png["GET button is highlighted to test the get call."]
+
