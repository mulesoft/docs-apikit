...
+
image::apikit-tutorial-3e0e4.png[height=633,width=600][alt=Project Settings for a New Mule Project, including Project Name, Runtime, Maven Settings, Version Control System Support, APIkit Settings, and API Definition.]
+
. Click *Finish*.
