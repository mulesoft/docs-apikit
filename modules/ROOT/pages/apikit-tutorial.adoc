...
+
image::apikit-tutorial-3e0e4.png[height=633,width=600][alt=New Mule Project window for project setting to select .raml file.]
+
. Click *Finish*.
...
+
image::apikitconsole-tutorial.png[alt=Remove Vending API example.]
+
...
+
image::fv-601.png[alt=Example displaying the try-it disabled because baseURI is not present.]
+
