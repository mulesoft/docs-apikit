...
APIkit is a toolkit that simplifies the development of API-led applications for Mule developers. It scaffolds applications from a given specification, validates inputs parameter validation, and creates https://docs.mulesoft.com/munit/2.3/munit-scaffold-test-task[MUnit test suites]. APIkit has a module for each supported web service:

* xref:apikit-4-forgraphql.adoc[APIkit for GraphQL] supports GraphQL APIs. 
* xref:apikit4-for-odatav2.adoc[APIkit for OData v2] and xref:apikit4-for-odatav4.adoc[APIkit for OData v4] support OData APIs. 
* xref:overview-apikit-for-rest.adoc[APIkit for REST] supports RAML and OAS APIs.
* xref:apikit-for-soap.adoc[APIkit for SOAP] supports SOAP APIs. 
...
* Some APIkit modules include extensions for https://docs.mulesoft.com/studio/latest/[Anypoint Studio] and https://docs.mulesoft.com/anypoint-code-builder/[Anypoint Code Builder] for enhancing your editing experience if you choose to use the supported development environments.
