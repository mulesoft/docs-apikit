...
Integrate APIkit for OData v2 with APIkit for REST by declaring the Maven dependencies, namespaces, and XML schema locations in this topic. Customize generated EntitySet names and router behavior from your RAML types when you need endpoints that differ from default pluralization.
