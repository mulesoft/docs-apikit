...
Date/DateTime values will be treated as a string by default in this operation. Select java.time object option to output the values as corresponding Date or DateTime object under java.time package
