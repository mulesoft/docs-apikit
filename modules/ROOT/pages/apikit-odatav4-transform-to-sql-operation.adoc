...
| SQL identifiers delimiter | Option to delimit identifiers in the generated SQL sentence. Available options are DOUBLE_QUOTES, BRACKETS, and BACK_TICKS.
...
| SQL limit rows | Option to limit the numbers of rows. Available options are LIMIT and FETCH_NEXT_ROWS_ONLY.
